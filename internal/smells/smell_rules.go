...
// RegisteredRule returns the registered rule with the given ID, or nil.
// The registry itself stays unexported — consumers outside the package get
// lookup, not mutation.
func RegisteredRule(id string) *SmellRule {
