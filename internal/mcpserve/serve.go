...
// ServeCmd returns the serve command for registration on the root command —
// registration hook #3 (mache-96c378); mcpserve never imports cmd.
...
func runServe(cmd *cobra.Command, args []string) error {
	...
	s := server.NewMCPServer("mache", serverVersion(),
