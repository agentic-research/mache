...
| [0014: Mache in the Constellation](adr/0014-mache-in-constellation.md)                   | Proposed                      | Locates mache as the structural-observation producer in the constellation (rosary observation-lattice, cloister CAS+bundle, LLO capnp protocol). Frames the existing sheaf/CAS/git-ingestion beads as steps of one design rather than independent items. |
