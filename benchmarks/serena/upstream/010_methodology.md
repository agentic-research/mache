...
1. **Comprehensive and unbiased by design.**
...
1. **Single-file edits** — small tweaks, medium rewrites, full-body replacements, insertions, and local renames.
1. **Multi-file changes** — cross-file renames, symbol and file moves, safe deletes, and inlining.
1. **Reliability & correctness** — scope precision, atomicity, and success signals.
1. **Workflow effects** — chained edits, stable vs. ephemeral addressing, and multi-step exploration.
